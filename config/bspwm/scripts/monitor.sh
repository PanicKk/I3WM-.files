...
ONLY_ONE_MONITOR_NAME="DP-4" # e.g: Laptop monitor name
MONITOR_ORDER="DP-4 HDMI1" # blank to default order, defines the order of the workspaces for the monitors
